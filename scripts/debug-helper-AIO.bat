...
call powershell -Command "(gc global.props) -replace '<MetamodLaunchName>.*</MetamodLaunchName>', '<MetamodLaunchName>%LauncherExe%</MetamodLaunchName>' | Out-File global.props"
call powershell -Command "(gc global.props) -replace '<MetamodLaunchCommnand>.*</MetamodLaunchCommnand>', '<MetamodLaunchCommnand>-game %LauncherMod%</MetamodLaunchCommnand>' | Out-File global.props"
call powershell -Command "(gc global.props) -replace '<MetamodGameDirectory>.*</MetamodGameDirectory>', '<MetamodGameDirectory>%GameDir%\</MetamodGameDirectory>' | Out-File global.props"
call powershell -Command "(gc global.props) -replace '<MetamodModName>.*</MetamodModName>', '<MetamodModName>%LauncherMod%</MetamodModName>' | Out-File global.props"
...
if exist "%productPath%" (
    "%productPath%" metamod.sln
    exit
)

@echo You can open metamod.sln with Visual Studio IDE now
pause
exit
