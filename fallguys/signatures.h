...
#define SV_TestEntityPosition_Signature "\x83\xF8\x0C\x2A\x2A\x83\xF8\x08\x2A\x2A\x51\xE8"
...
#define PM_PlayerTrace_Signature "\xE8\x2A\x2A\x2A\x2A\x83\xC4\x20\x2A\x2A\x24\x34\xB9\x11\x00\x00\x00"
