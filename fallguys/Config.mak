...
EXTRA_LINK += -L..$(SDKSRC)/../bullet3/build/lib -lBullet3Dynamics -lBullet3Collision -lBullet3Geometry -lBulletSoftBody -lBulletDynamics -lBulletCollision -lLinearMath