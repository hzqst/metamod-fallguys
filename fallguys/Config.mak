...
EXTRA_LINK += -L$(SDKSRC)/../bullet3/build/lib -Bstatic -lBullet3Dynamics -lBullet3Collision -lBullet3Geometry -lBulletSoftBody -lBulletDynamics -lBulletCollision -lLinearMath -Bdynamic