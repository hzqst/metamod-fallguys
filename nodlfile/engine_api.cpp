...
void NewCVarSetString(const char *szVarName, const char *szValue)
{
	if (!strcmp(szVarName, "sv_send_resources") && szValue[0] == '1')
	{
		g_engfuncs.pfnCVarSetString("sv_send_resources", "0");
...
enginefuncs_t meta_engfuncs = 
{
	...
	NewCVarSetString,						// pfnCVarSetString()
