call cmake -S "%~dp0bullet3" -B "%~dp0bullet3\build" -A Win32 -DUSE_GLUT=FALSE -DUSE_GRAPHICAL_BENCHMARK=FALSE -DUSE_MSVC_SSE2=TRUE -DUSE_MSVC_SSE=FALSE -DUSE_MSVC_AVX=FALSE -DBUILD_BULLET2_DEMOS=FALSE -DBUILD_BULLET_ROBOTICS_EXTRA=FALSE -DBUILD_BULLET_ROBOTICS_GUI_EXTRA=FALSE -DBUILD_CLSOCKET=FALSE -DBUILD_CPU_DEMOS=FALSE -DBUILD_ENET=FALSE -DBUILD_GIMPACTUTILS_EXTRA=FALSE -DBUILD_HACD_EXTRA=FALSE -DBUILD_INVERSE_DYNAMIC_EXTRA=FALSE -DBUILD_OBJ2SDF=FALSE -DBUILD_OPENGL3_DEMOS=FALSE -DBUILD_UNIT_TESTS=FALSE
